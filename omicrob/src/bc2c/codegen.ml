...
let export_code_from_codemap code codemap =
  ...
  Array.iteri (fun instr_ind instr ->
    ...
    | STD (ACC n) ->
      check_bounds "ACC" n 8 0xFFFF_FFFF;
    ...
    | STD (PUSHACC n) ->
      check_bounds "PUSHACC" n 8 0xFFFF_FFFF;
      export_opcode Opcode.PUSHACC;
      export_uint32 n;
    | STD (POP n) ->
      check_bounds "POP" n 1 0xFFFF_FFFF;
      export_opcode Opcode.POP;
      export_uint32 n;
    | STD (ASSIGN n) ->
      check_bounds "ASSIGN" n 0 0xFFFF_FFFF;
    ...
    | STD (ENVACC n) ->
      check_bounds "ENVACC" n 5 0xFFFF_FFFF;
    ...
    | STD (PUSHENVACC n) ->
      check_bounds "PUSHENVACC" n 5 0xFFFF_FFFF;
    ...
    | STD (PUSH_RETADDR ptr) ->
      ...
      export_ofs ofs;
    | STD (APPLY n) ->
      check_bounds "APPLY" n 4 0xFFFF_FFFF;
    ...
    | STD (APPTERM (n, p)) ->
      check_bounds "APPTERM n:" n 0 0xFFFF_FFFF;
      check_bounds "APPTERM p:" p 0 0xFFFF_FFFF;
      export_opcode Opcode.APPTERM;
      export_uint32 n;
      export_uint32 p;
    | STD (APPTERM1 n) ->
      check_bounds "APPTERM1" n 0 0xFFFF_FFFF;
      export_opcode Opcode.APPTERM1;
      export_uint32 n;
    | STD (APPTERM2 n) ->
      check_bounds "APPTERM2" n 0 0xFFFF_FFFF;
      export_opcode Opcode.APPTERM2;
      export_uint32 n;
    | STD (APPTERM3 n) ->
      check_bounds "APPTERM3" n 0 0xFFFF_FFFF;
      export_opcode Opcode.APPTERM3;
      export_uint32 n;
    | STD (RETURN n) ->
      check_bounds "RETURN" n 0 0xFFFF_FFFF;
      export_opcode Opcode.RETURN;
      export_uint32 n;
    | STD RESTART ->
      export_opcode Opcode.RESTART;
    | STD (GRAB n) ->
      check_bounds "GRAB" n 0 0xFFFF_FFFF;
    ...
    | STD (CLOSUREREC (f, v, o, t)) ->
      check_bounds "CLOSUREREC f:" f 0 0xFFFF_FFFF;
      check_bounds "CLOSUREREC v:" v 0 0xFFFF_FFFF;
